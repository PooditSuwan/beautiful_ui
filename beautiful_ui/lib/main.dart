    ...
    return MaterialApp(
      home: Scaffold(
          body: Container(
              child: Column(
        children: [
          Image.asset('assest/lake.jpg',
              width: 500, height: 240, fit: BoxFit.cover),
          Container(height: 15),
          TitleSection(),
          buttonSection(),
          description(),
  ...
  void _toggleFavorite() {
    setState(() {
      if (_isFavorited) {
        _favoriteCount -= 1;
        _isFavorited = false;
        EasyLoading.showInfo('Not Favorite');
      } else {
        _favoriteCount += 1;
        _isFavorited = true;
        ...
        Column(
          children: [
            IconButton(
              ...
              onPressed: () {
                html.window.open(
                    'https://www.youtube.com/watch?v=UYGhkvRttwI&t=1620s',
                    'Dart');
              },
            ),
            Text(
